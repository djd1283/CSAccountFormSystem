...
fs.writeFileSync("public_key.txt", JSON.stringify(keypair.publicKey), "utf8");
fs.writeFileSync("private_key.txt", JSON.stringify(keypair.privateKey), "utf8");
